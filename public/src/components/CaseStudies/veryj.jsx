...
import './case.scss';
const veryj_banner = 'https://ik.imagekit.io/breezy/Breezyblake/veryj/movint_banner3_i8g3G6zmK.jpg?ik-sdk-version=javascript-1.4.3&updatedAt=1648529297657';
...
const Tako = () => {
  return (
    <section className="case-page">
      <div className="case-banner" style={{background: `url(${veryj_banner}) 50% 50%`, backgroundSize: 'cover'}}>
      ...
      <div className="case-summary container">
        <div className="case-summary-divider row">
          <div className="case-summary-left">
            <p>
            VERY J [ 'ver-ee jey ] DETAIL, FASHION, TRENDS. With a keen eye for what's next to come and a relentless drive to surpass expectations, Very J has been assisting customers acquire style—and not just purchase fashion. </p>              
